...
export const BlogItems = [
    ...
    },
    {
        id: 3,
        title: 'The Result',
        desc: 'Thoughts on my first completed project',
        cover: card3,
        text:`Once published, I felt incredibly satisfied with the final result. I learned new design elements, CSS animations, basic code, and it was a progressive journey with my own code writing. As I put more thought into how the elements were organized and how the code was written to be the most efficient but also the simplest it can be. 
